...
final class StockPlugin: Plugin {
    ...
    private func getInitials(from name: String) -> String {
        ...
        let pinyinMap: [String: String] = [
            ...
            "压": "Y", "呀": "Y", "牙": "Y", "言": "Y", "研": "Y", "眼": "Y", "演": "Y", "样": "Y", "要": "Y", "也": "Y", "业": "Y", "叶": "Y", "夜": "Y", "一": "Y", "医": "Y", "已": "Y", "以": "Y", "义": "Y", "意": "Y", "因": "Y", "音": "Y", "银": "Y", "应": "Y", "英": "Y", "影": "Y", "用": "Y", "由": "Y", "有": "Y", "又": "Y", "于": "Y", "与": "Y", "语": "Y", "元": "Y", "园": "Y", "原": "Y", "源": "Y", "远": "Y", "院": "Y", "愿": "Y", "月": "Y", "越": "Y", "云": "Y", "运": "Y", "宇": "Y",
