...
final class SetupWizardWindow: NSWindow {
    ...
    private func showStep(_ step: Int) {
        ...
        case 1:
            ...
            descriptionLabel.stringValue = "Keystarter needs some permissions to work properly.\n\nClick Next to grant permissions."
            hotkeyRecorder.isHidden = true
            nextButton.title = "Grant Permissions"

        case 2:
            stepLabel.stringValue = "Step 3 of 3: Status Bar"
            descriptionLabel.stringValue = "Choose how the status bar icon appears.\n\nYou can change this later in Settings."
            hotkeyRecorder.isHidden = true
    ...
    @objc private func nextStep() {
        ...
        case 1:
            // Request permissions
            PermissionManager.shared.requestAllPermissions { [weak self] in
                self?.showStep(2)
            }
